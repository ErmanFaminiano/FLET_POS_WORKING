...
def new_transaction_page(page: ft.Page, view: ft.View):
    ...
    view.bgcolor = ft.colors.PINK_900
    ...
    checkout_dlg=ft.AlertDialog(
        ...
        actions=[
            cancel,
            ft.TextButton('Pay', on_click=confirm_payment, ),
        ],       
    )
    ...
    side_nav = ft.Container(
        ...
        content=ft.Column(
            controls=[
                ...
                ft.Container(
                    content=ft.ElevatedButton('CHECKOUT', width=1000, bgcolor ="ORANGE", color="WHITE" ,on_click=open_checkout),
                )
            ]
        )
    )
